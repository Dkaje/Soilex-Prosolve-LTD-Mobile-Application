...
?>
	<?php 
		...
		if (empty($keyword)) {
			$sql_query = "SELECT * FROM tbl_driver WHERE status=1 ORDER BY id DESC LIMIT ?, ?";
		} else {
							...
							<tbody>
								<tr>
									...
									<td>
									    ...
									    <a href="driverApproved.php?id=<?php echo $data['id'];?>" onclick="return confirm('Are you sure want to permanently delete this customer?')" >
